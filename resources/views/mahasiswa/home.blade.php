...
<div class="container mx-auto p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 class="text-xl font-semibold text-gray-800 mb-4">Profil Mahasiswa</h3>
            <p class="text-gray-600">Lihat detail informasi akademik Anda, termasuk IPK, status studi, dan dosen wali.</p>
            <a href="{{ route('mahasiswa.profile') }}" class="mt-4 inline-block px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition duration-300">Lihat Profil</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <a href="{{ route('mahasiswa.profile') }}" class="mt-4 inline-block px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition duration-300">Lihat Jadwal</a>
        </div>
    </div>
</div>
