...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.dosen.pembimbing.index') }}" class="inline-block px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition duration-200">
        ...
        <form action="{{ route('admin.dosen.pembimbing.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="kapasitas_maksimum" name="kapasitas_maksimum" value="{{ old('kapasitas_maksimum', 5) }}" placeholder="5" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500" min="1">
