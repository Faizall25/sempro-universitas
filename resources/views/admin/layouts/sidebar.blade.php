        ...
        <ul class="text-sm text-gray-600 space-y-2">
            ...
            <li x-data="{ open: false }">
                ...
                <ul x-show="open" class="pl-6 mt-1 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.dosen.penguji.index') }}" class="flex items-center space-x-3 p-2 rounded-lg {{ request()->routeIs('admin.dosen.penguji.*') ? 'bg-gray-200 text-teal-700' : 'hover:bg-gray-200' }}">
