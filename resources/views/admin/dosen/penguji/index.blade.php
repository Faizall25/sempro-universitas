                    ...
                    @foreach ($dosen as $index => $item)
                        <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-200 ease-in-out">
                            ...
                            <td class="px-6 py-4 flex space-x-2">
                                <a href="{{ route('admin.dosen.penguji.edit', $item->id) }}" class="px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out" data-tooltip="Edit data dosen">
